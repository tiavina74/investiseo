    ...
    return (
        <div className='contenu '>
            ...
            <div className="dashboard-header">
                    <h4 className='dashboard'>Publication</h4>
                ...
                <div className='tableau'>
                    <div className="table-section">
                        <h5 className="table-title">Listes des publications</h5>
                        ...
                        <table className="tableaux table table-bordered">
                            ...
                            <tbody>
                                <tr className="table-success">
                                    ...
                                    <td>Approuvé</td>
                                    <td>
                                        <i className="fas fa-eye" title="Détails"></i>&nbsp;
                                        <i className="fas fa-check" title="Approuver"></i>&nbsp;
                                        <i className="fas fa-times" title="Rejeter"></i>
                                    </td>
                                </tr>
